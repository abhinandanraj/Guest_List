package finalguestlist;

import java.util.Scanner;

public class FinalGuestList {
    ...
    static void insertGuest() {
        ...
        if (num >= 1 && num <= 10 && guests[num - 1] != null) {
            ...
            if (guests.length - 1 - (num - 1) >= 0)
                System.arraycopy(guests, num - 1, guests, num, guests.length - 1 - (num - 1));
    ...
    static void insertTestNames() {
        guests[0] = "Abhinandan Raj";
        guests[1] = "Abhinav Anand";
        guests[2] = "Abhishek Yadav";
        guests[3] = "Ram Singh";
        guests[4] = "Shyam Singh";
    }
